<template>
  <section>
    ...
    <div class="card-img-overlay d-flex flex-column justify-content-center align-item-center">
      <h1 class="card-title  text-center fw-bold" > 聯絡我們 </h1>
    </div>
  </div>
    <div class="about container">
      <div class="contentText text-center my-5">
          <ul>
              <li class="fs-5 fw-bold border-2 border-bottom border-dark d-inline-block mb-3">服務電話 </li>
              <li class="mb-3 text-soft">0800-123-456</li>
              <li class="fs-5 fw-bold border-2 border-bottom border-dark d-inline-block mb-3">服務信箱</li>
              <li class="mb-3 text-soft">service@rehouse.com</li>
              <li class="fs-5 fw-bold border-2 border-bottom border-dark d-inline-block mb-3">服務時間</li>
              <li class="mb-3 text-soft">週一~週五 08:00-19:00 </li>
              <li class="mb-3 text-soft">週六~週日及國定例假日 09:00~18:00</li>
              <li class="fs-5 fw-bold border-2 border-bottom border-dark d-inline-block mb-3">常見問題</li>
              <li class="mb-5 text-soft">需要立即查詢，可以參考相關<router-link class="nav-link d-inline-block p-0 " to="/faq">常見問題</router-link></li>
              <li class="fs-5 fw-bold">我們非常重視您的意見與問題，歡迎來電或來信詢問<br>我們將協助處理及回覆，祝你有個質感生活。</li>
          </ul>
      </div>
    </div>
  </section>
